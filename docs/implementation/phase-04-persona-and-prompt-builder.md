# Fase 04 — Persona e prompt builder configurável

## Objetivo

Implementar persona configurável, context builder e prompt builder testável.
...
Fase 04 concluída. Posso prosseguir para a próxima fase?
```
