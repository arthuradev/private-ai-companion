# Fase 10 — Visão de tela com política de privacidade

## Objetivo

Implementar screenshot autorizado, redaction, visual context e vision providers.
...
Fase 10 concluída. Posso prosseguir para a próxima fase?
```
