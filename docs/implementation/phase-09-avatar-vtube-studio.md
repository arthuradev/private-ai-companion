# Fase 09 — Avatar com VTube Studio/Live2D

## Objetivo

Implementar avatar port, VTube Studio adapter, expressões, idle e lipsync.
...
Fase 09 concluída. Posso prosseguir para a próxima fase?
```
